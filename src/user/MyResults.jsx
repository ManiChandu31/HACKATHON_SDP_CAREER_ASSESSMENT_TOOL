  ...
  return (
    <div className="page-shell">
      <div className="page-card">
        <h2 className="form-title">View My Results</h2>

        {results.length === 0 ? (
          <div style={{textAlign: 'center', padding: '3rem'}}>
            <p style={{fontSize: '1.2rem', marginBottom: '1rem'}}>📋 No assessment results found.</p>
            <p>Complete scheduled exams to view your results here.</p>
          </div>
        ) : selectedResult ? (
          <div className="result-detail">
            ...
            {getFeedback(results.indexOf(selectedResult)) && (
              <div className="admin-feedback-section">
                <h4>Expert Guidance from Faculty</h4>
